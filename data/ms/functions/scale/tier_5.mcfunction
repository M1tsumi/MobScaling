...
execute if score #ms_scaling_absolute ms_player_tmp matches 0 run execute store result entity @s Attributes[0].BaseModifiers[{Name:"generic.max_health",Amount:0.0f,Operation:0,UUID:[I;0,0,0,5]}] float 1 run scoreboard players get #ms_health_multiplier_tier_5 ms_player_tmp
execute if score #ms_scaling_absolute ms_player_tmp matches 0 run execute store result entity @s Attributes[0].BaseModifiers[{Name:"generic.attack_damage",Amount:0.0f,Operation:0,UUID:[I;0,0,0,5]}] float 1 run scoreboard players get #ms_damage_multiplier_tier_5 ms_player_tmp
